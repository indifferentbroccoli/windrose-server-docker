...
export WORLD_ISLAND_ID="${WORLD_ISLAND_ID:-}"
export AUTO_LOAD_LATEST_BACKUP="${AUTO_LOAD_LATEST_BACKUP:-true}"
...
su - steam -w "INVITE_CODE,USE_DIRECT_CONNECTION,SERVER_PORT,DIRECT_CONNECTION_PROXY_ADDRESS,USER_SELECTED_REGION,SERVER_NAME,SERVER_PASSWORD,MAX_PLAYERS,P2P_PROXY_ADDRESS,WORLD_ISLAND_ID,AUTO_LOAD_LATEST_BACKUP,GENERATE_SETTINGS,UE4SS_ENABLED,WINDROSE_PLUS_ENABLED,WINDROSE_PLUS_VERSION,WINDROSE_PLUS_VERSION_DEFAULT,WINDROSE_PLUS_DASHBOARD_PORT,WINDROSE_PLUS_RCON_PASSWORD,WINE_VERBOSE" \
